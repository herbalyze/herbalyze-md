...
import com.dayeeen.herbalyze.databinding.ActivityLoginBinding
    ...
    private fun googleSignIn() {
        ...
        lifecycleScope.launch {
            try {
                ...
                handleSignIn(result)
            } catch (e: androidx.credentials.exceptions.GetCredentialException) { //import from androidx.CredentialManager
